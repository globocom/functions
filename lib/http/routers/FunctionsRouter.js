...
router.put('/:namespace/:id/env/:env', bodyParser.json({ strict: false }), (req, res) => {
...
router.all('/:namespace/:id/run', bodyParser.json(), (req, res) => {
  ...
  memoryStorage
    ...
    .then((code) => {
      ...
      return sandbox.runScript(code.script, req, { prefix: prefix(namespace, id), env: code.env });
    })
    .then((result) => {
