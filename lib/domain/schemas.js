...
const functionsNavigation = [
  {
    rel: 'previous',
    href: '/functions/{namespace}/{id}?page={previousPage}&perPage={perPage}',
  },
  {
    rel: 'next',
    href: '/functions/{namespace}/{id}?page={nextPage}&perPage={perPage}',
  },
  {
    rel: 'page',
    href: '/functions/{namespace}/{id}?page={page}&perPage={perPage}',
  },
];
