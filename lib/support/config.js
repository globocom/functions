...
module.exports = {
  ...
  googleCloudCredentials: process.env.GOOGLE_CREDENTIALS || null,
  metric: {
  ...
  gcfProjectId: process.env.GOOGLE_CLOUD_FUNCTION_PROJECT_ID || null,
  gcfBucketId: process.env.GOOGLE_CLOUD_FUNCTION_BUCKET_ID || null,
  gcfZoneId: process.env.GOOGLE_CLOUD_FUNCTION_ZONE_ID || null,
