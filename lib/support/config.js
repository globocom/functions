...
module.exports = {
  ...
  otel: {
    engine: process.env.OTEL_EXPORTER_ENGINE,
    collector: {
      host: process.env.OTEL_COLLECTOR_HOST || 'no-op', //jaeger, zipkin, apm, etc...
      port: process.env.OTEL_COLLECTOR_PORT || 55680
    },
    service: process.env.OTEL_EXPORTER_SERVICE
  },
  useOpenTelemetry: process.env.USE_OPENTELEMETRY || false,
