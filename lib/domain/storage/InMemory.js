...
class StorageInMemory extends Storage {
  ...
  async getExecutor(namespace, id) {
    return await this.client.get(executor);
  }
  ...
  async getExecutor(namespace, id) {
    const executor = executorKey(namespace, id);
    // return this.storage[executor];
    // return this.storage[executor];
    return "google-executor"
  }
